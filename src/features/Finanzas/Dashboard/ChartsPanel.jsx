      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl card-soft border border-[#E9DFD9]">
          <div className="flex items-center space-x-2 mb-6">
            ...
            <h3 className="text-base font-bold text-[#2C211F]">Comparativa Diaria de Sedes (Ingresos)</h3>
          </div>
          
          <div className="h-[300px] w-full">
            {chartSedesData.length === 0 ? (
              <div className="flex justify-center items-center h-full text-[#877571]">No hay datos suficientes para graficar.</div>
            ) : (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartSedesData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  <Tooltip 
                    ...
                    contentStyle={{ borderRadius: '12px', border: '1px solid #E9DFD9', boxShadow: '0 4px 12px rgba(58, 15, 15, 0.08)' }}
                  />
        ...
        <div className="bg-white p-6 rounded-2xl card-soft border border-[#E9DFD9] flex flex-col">
          <div className="flex items-center space-x-2 mb-2">
            <PieIcon className="text-[#3A0F0F]" size={20} />
            <h3 className="text-base font-bold text-[#2C211F]">Distribución de Medios</h3>
          </div>
          
          <div className="flex-1 min-h-[200px] relative flex items-center justify-center">
            {paymentMethodsData.length === 0 ? (
              <div className="text-[#877571] text-sm">Sin datos registrados.</div>
            ) : (
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
